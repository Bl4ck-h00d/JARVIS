...
contacts = {
    'contact1' : 'contact1@gmail.com',
    'contact2' : 'contact2@gmail.com',
    'contact3' : 'contact3@gmail.com',
    'contact4' : 'contact4@yahoo.com'
...
def sendEmail(to,body):
    ...
    server.sendmail('youremail@gmail.com', to, body)
    server.close()
